...
function Fenglib:CreateWindow(Config)
	...
	local BackgroundEffect = Config.BackgroundEffect or "None"   -- "GradientFlow" / "Noise" / "None"
	...
	-- ================== 高级背景渲染 ==================
	local bgEffectFrame
	if BackgroundEffect == "GradientFlow" then
		bgEffectFrame = Instance.new("Frame")
		bgEffectFrame.Size = UDim2.new(1, 0, 1, 0)
		bgEffectFrame.BackgroundTransparency = 1
		bgEffectFrame.BorderSizePixel = 0
		bgEffectFrame.Parent = MainFrame
		bgEffectFrame.ZIndex = 0
		...
		bgGradient.Color = ColorSequence.new({
			...
			ColorSequenceKeypoint.new(0.6, Color3.fromRGB(255, 180, 200)),
			ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 255, 255))
		})
		bgGradient.Parent = bgEffectFrame

		bgEffectFrame.BackgroundColor3 = Color3.new(1, 1, 1)
		bgEffectFrame.BackgroundTransparency = 0.85

		RunService.RenderStepped:Connect(function(delta)
			if bgEffectFrame and bgEffectFrame.Parent then
				bgGradient.Rotation = (bgGradient.Rotation + delta * 8) % 360
			end
		end)

	elseif BackgroundEffect == "Noise" then
		bgEffectFrame = Instance.new("ImageLabel")
		bgEffectFrame.Name = "NoiseBackground"
		bgEffectFrame.Size = UDim2.new(1, 0, 1, 0)
		bgEffectFrame.BackgroundTransparency = 1
		bgEffectFrame.Image = "rbxassetid://8078831659"
		bgEffectFrame.ImageTransparency = 0.92
		bgEffectFrame.ScaleType = Enum.ScaleType.Tile
		bgEffectFrame.TileSize = UDim2.new(0, 128, 0, 128)
		bgEffectFrame.ZIndex = 0
		bgEffectFrame.Parent = MainFrame
	end
	-- =================================================
